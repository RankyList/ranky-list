<div class="container mx-auto flex flex-col gap-8 text-2xl">
    ...
    <p class="unstyled">
        If you would like to enable Javascript, please follow the instructions on
        <a href="https://www.enable-javascript.com/" rel="noopener noreferrer" target="_blank">this website</a>. It provides a helpful guide on how to
        do so for various web browsers.
    </p>
    <p class="unstyled">Thank you for your understanding and we hope you have a great experience using RankyList.</p>
    <p class="unstyled">Sincerely, The RankyList Team</p>
</div>
